            ...
            <div className={`${RoomsCss.Card_Back} ${RoomsCss.Card_Back1}`}>
              ...
              <div className={RoomsCss.BookNow}>
                ...
                <i
                  ...
                  onClick={() => openSlider([img1, img2, img3])}
                ></i>
              </div>
            </div>
          </div>
        ...
        {isModalOpen && (
          <div className={RoomsCss.modal}>
            <div className={RoomsCss.modalContent}>
              <button className={RoomsCss.closeButton} onClick={closeSlider}>
                X
              </button>
              <div className={RoomsCss.slider}>
                {/* Previous Button */}
                <button onClick={prevImage} className={RoomsCss.prevButton}>
                  ←
                </button>
                ...
                {/* Next Button */}
                <button onClick={nextImage} className={RoomsCss.nextButton}>
                  →
                </button>
              </div>
            </div>
