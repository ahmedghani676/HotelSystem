...
import img2 from './../../assets/mens.jpg'
import img3 from './../../assets/menss.jpg'
      ...
      <Swiper
        ...
        <SwiperSlide>
          <div className={`${TestimonialCss.amenities_item}`}>
            ...
            <div className={TestimonialCss.content}>
              <h2>Sami <span>Sales Manager</span></h2>
              <p>
