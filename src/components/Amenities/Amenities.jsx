...
export const Amenities = () => {
  return (
    <div
      id="amenities"
      className={`${AminitiesCss.aminitiesCss_wrapper} section`}
    >
        ...
        <SwiperSlide>
          <div className={`${AminitiesCss.amenities_item}`}>
            ...
            <div className={AminitiesCss.content}>
              <h2>Swimming Pool</h2>
              <p>
                Dive into luxury with our stunning swimming pool, designed for
                relaxation and recreation. Whether you're swimming laps or just
                soaking up the sun, our pool area offers a perfect escape with
        ...
        <SwiperSlide>
          <div className={`${AminitiesCss.amenities_item}`}>
            ...
            <div className={AminitiesCss.content}>
              ...
              <p>
                Indulge in a culinary journey at our on-site restaurant and
                cafe, offering a delightful selection of international and local
                dishes. Whether you're in the mood for a cozy coffee or an
                elegant dinner, our dining experience is sure to satisfy your
                cravings.
              </p>
              <Link to="rooms" smooth={true} duration={500}>
                <button>Book Now</button>
