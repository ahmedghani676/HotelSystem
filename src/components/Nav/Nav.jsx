...
const Nav = () => {
    ...
    return (
        <div className={navCss.nav_wrapper}>
            ...
            <ul ref={menu} className={navCss.navList}> {/* Add navList class to style */}
                ...
                <li><Link to="service" smooth={true} duration={500} onClick={closeMenu}>Services</Link></li>
                <li><Link to="amenities" smooth={true} duration={500} onClick={closeMenu}>Amenities</Link></li>
                <li><Link to="testimonials" smooth={true} duration={500} onClick={closeMenu}>Testimonials</Link></li>
                <li><Link to="contacts" smooth={true} duration={500} onClick={closeMenu}>Contact Us</Link></li>
            </ul>
